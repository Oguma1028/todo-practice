...
var onClickAdd = function onClickAdd() {
  ...
  backButton.innerText = "戻す"; // 未完了のリストから削除するやつ
  ...
  completeButton.addEventListener("click", function () {
    var divOfParent = completeButton.parentNode;
    deleteFromIncompleteList(divOfParent);
    var liOfParent = divOfParent.parentNode;
    liOfParent.textContent = null;
    var text = divOfParent.firstElementChild.innerText; // Li配下のタブを生成
    ...
    p.innerText = text;
    var backButton = document.createElement("button");
    backButton.innerText = "戻す"; // liと上の３つを合体

    li.appendChild(div);
    div.appendChild(p);
    div.appendChild(backButton); // 完了ゾーンに追加
